        ...
        <div class="row">
            <div class="jumbotron col-12 mb-0">
                <div class="display-3 text-center text-dark" style="font-size:2.0rem;letter-spacing:-2px;line-height:.7 !important;">
                    <h1 class="mb-0" style="line-height:.7;"><span style="font-size:2.0rem;letter-spacing:-2px;line-height:.7 !important;">RETAIL</span></h1>
                    <h1 class="mb-0" style="line-height:.7;"><span style="font-size:2.0rem;letter-spacing:-2px;line-height:.7 !important; ">FOR LEASE</span></h1>
